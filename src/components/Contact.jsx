...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const templateParams = {
      ...
      subject,
      message,
      timestamp: new Date().toLocaleString('en-US', { timeZone: 'Asia/Kolkata' }) // IST timestamp
    };

    // Send email using EmailJS
    emailjs.send('service_rl1he4m', 'template_5l7q0fg', templateParams)
      .then(response => {
        setFormMessage({
  ...
  return (
    <div
      id="contact"
      className={`py-48 px-[5%] ${sectionInView ? 'animate__animated animate__fadeIn' : 'opacity-0'}`}
      ref={sectionRef}
    >
      <div
        ref={titleRef}
      ...
      <div className="flex flex-col justify-center items-center pt-18 lg:flex-row lg:justify-start lg:px-92">
        <div>
          <h1
            ...
            className={`gradient-text font-black text-center text-2xl lg:text-4xl lg:text-left ${
              getInTouchInView ? 'animate__animated animate__fadeInRight animate__delay-0s' : 'opacity-0'
            }`}
          >
            GET IN TOUCH
          </h1>
          <h3
            ...
            className={`text-sm text-center pt-8 lg:text-left ${
              descInView ? 'animate__animated animate__fadeInRight animate__delay-0s' : 'opacity-0'
            }`}
          >
            I'm always open to connecting, whether it's for a potential collaboration, an exciting
            opportunity, or just a good conversation about tech and innovation.
          </h3>
          ...
          <Magnet padding={50} disabled={false} magnetStrength={10}>
            <a
              ...
              className={`btn btn-ghost btn-circle bg-zinc-300 h-8 w-8 ${
                social1InView ? 'animate__animated animate__zoomIn animate__delay-0s' : 'opacity-0'
              }`}
              ref={social1Ref}
            >
              <svg
            ...
            <a
              ...
              target="_blank"
              className={`btn btn-ghost btn-circle bg-zinc-300 h-8 w-8 ${
                social2InView ? 'animate__animated animate__zoomIn animate__delay-0s' : 'opacity-0'
              }`}
              ref={social2Ref}
            >
              <svg
            ...
            <a
              ...
              target="_blank"
              className={`btn btn-ghost btn-circle bg-zinc-300 h-8 w-8 ${
                social3InView ? 'animate__animated animate__zoomIn animate__delay-0s' : 'opacity-0'
              }`}
              ref={social3Ref}
            >
              <svg
            ...
            <a
              ...
              target="_blank"
              className={`btn btn-ghost btn-circle bg-zinc-300 h-8 w-8 ${
                social4InView ? 'animate__animated animate__zoomIn animate__delay-0s' : 'opacity-0'
              }`}
              ref={social4Ref}
            >
              <svg
        ...
        <div className="flex flex-col justify-center items-center pt-16">
          ...
          {formMessage.visible && (
            <div 
              className={`mb-4 text-center text-sm ${formMessage.isError ? 'text-[#ff4444]' : 'text-[#00cc00]'}`}
            >
              {formMessage.text}
            </div>
          )}
          ...
          <form
            ...
            className={`flex flex-col justify-center items-center gap-4 w-120 ${
              formInView ? 'animate__animated animate__fadeInLeft animate__delay-0s' : 'opacity-0'
            }`}
            ref={formRef}
          ...
          >
            <input
              ...
              className={`input rounded-lg text-sm bg-[#ffffff15] border-none ${
                input1InView ? 'animate__animated animate__fadeInLeft animate__delay-0s' : 'opacity-0'
              }`}
              type="text"
            ...
            <input
              id="email"
              className={`input rounded-lg text-sm bg-[#ffffff15] border-none ${
                input2InView ? 'animate__animated animate__fadeInLeft animate__delay-0s' : 'opacity-0'
              }`}
              type="email"
              placeholder="Email"
              ref={input2Ref}
            ...
            <input
              id="subject"
              className={`input rounded-lg text-sm bg-[#ffffff15] border-none ${
                input3InView ? 'animate__animated animate__fadeInLeft animate__delay-0s' : 'opacity-0'
              }`}
              type="text"
              placeholder="Subject"
              ref={input3Ref}
            ...
            <textarea
              ...
              className={`textarea rounded-lg text-sm bg-[#ffffff15] border-none ${
                textareaInView ? 'animate__animated animate__fadeInLeft animate__delay-0s' : 'opacity-0'
              }`}
              placeholder="Message"
              ref={textareaRef}
  ...
  {isLoading ? (
    ...
    <button
              className={`sexybutton text-sm h-[35px] w-[200px] ${
                buttonInView ? 'animate__animated animate__fadeInLeft animate__delay-0s' : 'opacity-0'
              }`}
              type="submit"
              ref={buttonRef}
            >
